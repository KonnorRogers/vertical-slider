...
Let's combine the vendor-specific styles into a single CSS declaration to see how each browser actually renders vertical sliders.
...
<!-- TODO Might be nice to show a screenshot of each browser's implementation here -->

Feel free to checkout the example here: <https://jsfiddle.net/m0btsq89/5/> <!-- TODO - move this to CodePen and embed the pen in lieu of the above code -->
...
<!-- TODO - ditch the starter step-by-step and jump right into what the component looks like. At the end of the post, link to the full repo where they can explore the starter and everything in it. -->
...
import { normalize } from '../normalize' // TODO - where is this coming from? Can it be removed?
...
<!-- TODO - consider making this a codepen example -->
...
<!-- TODO - show thumb + track styles up to this point; consider making it a codepen example -->
